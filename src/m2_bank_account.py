...
def run_test_init():
    ...
    b3 = Bank('Boris', -2304, 'A3')
    expected_name = 'Boris'
    expected_balance = -2304
...
def run_test_withdraw():
    ...
    b1 = Bank('Brackin', 10000, 'A1')
    print("Expected:", 10000 - 2589)
    print("Actual:  ", b1.withdraw(2589))
    if b1.withdraw(2589) == (10000 - 2589):
        print("Test passed SUCCESSFULLY!")
    else:
        print_failure_message()
    print()
    ...
    # DONE: 2. Add two more test cases for your Bank class below.
    # ---------------------------------------------------------------------
    b2 = Bank('Bob', -235879, 'A2')
    print("Expected:", "Insufficient Funds!")
    print("Actual:  ", b2.withdraw(500))
    if b2.withdraw(500) is None:
        print("Test passed SUCCESSFULLY!")
    else:
        print_failure_message()
    print()
